...
I built and open sourced [Dnsonward](https://github.com/eldridgea/dnsonward). It’s a docker container that can be started and pointed to some popula DoT servers and also allow you to configurre you’re own. This is built on top of the excellent [CoreDNS](https://coredns.io/) -- written in go, perfomrant, and modular it fit this usecase perfectly.
...
You can replace `cloudflare` with either `google` or `quad9`. You can also pass enviornment variables to have it point at any DoT server, those details are in the [README](https://github.com/eldridgea/dnsonward).
