...
draft: false
hero: "https://blog.eldrid.ge/cdn-cgi/image/format=auto/img/workers-illustration.png"
slug: "lil-link"
title: "Lil Link"
...
I'll be offering a hosted version later this summer for anyone that doesn't want to, or can't, maintain their own installation, but some organizations will hopefully find this useful after a quick `wrangler publish`.
